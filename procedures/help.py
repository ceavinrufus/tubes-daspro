def help_user():
    # I.S. -
    # F.S. Menampilkan instruksi pemakaian perintah untuk user
...
def help_admin():
    # I.S. -
    # F.S. Menampilkan instruksi pemakaian perintah untuk admin
...
def help_guest():
    # I.S. -
    # F.S. Menampilkan instruksi pemakaian perintah untuk guest
